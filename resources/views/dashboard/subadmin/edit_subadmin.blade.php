                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control text-capitalize @error('fullname') is-invalid @enderror" id="fullname" name="fullname" placeholder="Enter subadmins's first name" value="{{ old('fullname') ? old('fullname') : $subadmin->fullname }}" required autofocus>
                            @error('fullname')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" placeholder="Enter subadmin's other names" value="{{ old('username') ? old('username') : $subadmin->username }}" required>
                            @error('username')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="account_type" name="account_type" placeholder="e.g No 1, Kudang Street" value="{{ old('account_type') ? old('account_type') : $subadmin->addresses->first()->account_type }}" required>
                            @error('account_type')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
