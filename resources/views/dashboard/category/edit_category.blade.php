                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') ? old('name') : $category->name }}" class="form-control @error('name') is-invalid @enderror" autofocus required>
                            @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <br>
                            <label for="logo">Current Category Image</label> <br>
                            <img width="255" src="{{ $category->images->first() ? asset('storage/uploads/categories/images/' . $category->images->first()->name) : asset('storage/uploads/categories/images/'. 'avatar.png') }}"/>
                            <br/>
                        </div>
                    </div>
