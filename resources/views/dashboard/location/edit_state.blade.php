        ...
        <div class="row">
          ...
          <div class="col">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="{{ url('/admin/update_state', [$state->id]) }}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="name">Name<span class="text-danger">*</span> <small>(You can enter multiple states separeted by comma e.g Abuja, Lagos, Enugu)</small></label>
                            <input type="text" id="name" name="name" value="{{ old('name') ? old('name') : $state->name }}" class="form-control @error('name') is-invalid @enderror" autofocus required>
                            @error('name')
