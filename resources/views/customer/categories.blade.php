                                                ...
                                                @foreach($categories->forPage($_GET['page'], 16) as $category)
                                                    <div class="product">
                                                        ...
                                                        <a class="woocommerce-LoopProduct-link woocommerce-loop-product__link" href="{{url('/stores') . '?' . http_build_query(['category_name' => $category->name])}}">
                                                            <img width="224" height="197" alt="" class="attachment-shop_catalog size-shop_catalog wp-post-image" src="{{ asset('storage/uploads/categories/images/'.$category->get_image()) }}">
                                                            <h2 class="woocommerce-loop-product__title text-capitalize text-truncate pb-0">{{$category->name}}</h2>
                                                        </a>
                                                        <!-- .woocommerce-LoopProduct-link -->
                                                        <div class="hover-area">
                                                            <a class="button" href="{{url('/stores') . '?' . http_build_query(['category_name' => $category->name])}}">View Stores</a>
                                                        </div>
                                                        <!-- .hover-area -->
                                                    </div>
                                                @endforeach
                                ...
                                <div class="shop--bar-bottom">
                                    ...
                                    <nav class="woocommerce-pagination">
                                        <ul class="page-numbers">
                                            @for($i = 1; $i <= ceil($categories->count()/16) ; $i++)
                                                <li>
                                ...
                                <ul class="product-categories ">
                                    <li class="product_cat">
                                        ...
                                        <ul>
                                            ...
                                            <li class="cat-item text-capitalize text-truncate">
                                                <a href="{{url('/stores') . '?' . http_build_query(['category_name' => $category->name])}}">
