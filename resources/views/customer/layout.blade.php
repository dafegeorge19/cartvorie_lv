...
<html lang="en-US" itemscope="itemscope" itemtype="http://schema.org/WebPage">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('customer/css/colors/red.css') }}" media="all" />
        ...
        <div id="page" class="hfeed site">
                        ...
                        <div class="row">
                            ...
                            <div class="site-branding">
                                <a href="home-v1.html" class="custom-logo-link" rel="home">
                                    <img width="100px" src="customer\images\logo.png" alt="">
                                </a>
                                <!-- /.custom-logo-link -->
                            </div>
                            <!-- /.site-branding -->
                            ...
                            <nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation" data-nav="flex-menu">
                                <ul id="menu-primary-menu" class="nav yamm">
                                    <li class="sale-clr yamm-fw menu-item animate-dropdown">
                                        <a title="Super deals" href="#">All Stores</a>
                                    </li>
                                    <li class="menu-item animate-dropdown">
                                        <a title="Super deals" href="">All Categories</a>
                                    </li>
                                    <li class="menu-item animate-dropdown">
                                        <a title="Super deals" href="">All Products</a>
                                    </li>
                                    <li class="menu-item animate-dropdown">
                                        <a title="Super deals" href="">Agents</a>
                                    </li>
                                    <li class="menu-item animate-dropdown">
                                        <a title="Headphones Sale" href="product-category.html">Contact Us</a>
                                    </li>
                                    <li class="menu-item">
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-addon search-categories popover-header">
                                    <select name='product_cat' id='product_cat' class='postform resizeselect'>
                                        <option value='0' selected='selected'>All Stores</option>
                                                ...
                                                <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                                                    <li class="woocommerce-mini-cart-item mini_cart_item">
                                                        ...
                                                        <a href="single-product-sidebar.html">
                                                            <img src="assets/images/products/mini-cart1.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="">XOddNE Wireless Controller&nbsp;
                                                        </a>
                                            ...
                                            <div class="widget_shopping_cart_content">
                                                <ul class="woocommerce-mini-cart cart_list product_list_widget " style="min-width: 100px !important;">
                                                    <li class="woocommerce-mini-cart-item mini_cart_item" style="min-width: 100px !important;">
                                                        <a href="single-product-sidebar.html" style="min-width: 100px !important;">
                                                            <img src="assets/images/products/mini-cart1.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="">My Orders
                                                        </a>
                                                    </li>

                                                    <li class="woocommerce-mini-cart-item mini_cart_item" style="min-width: 100px !important;">
                                                        <a href="single-product-sidebar.html" style="min-width: 100px !important;">
                                                            <img src="assets/images/products/mini-cart1.jpg" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image" alt="">Logout
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
                                ...
                                <nav id="handheld-navigation" class="handheld-navigation" aria-label="Handheld Navigation">
                                    ...
                                    <div class="handheld-navigation-menu">
                                        ...
                                        <ul id="menu-departments-menu-1" class="nav">
                                            <li class="highlight menu-item animate-dropdown">
                                                <a title="Value of the Day" href="javascript:void(0)">Top Stores</a>
                                            </li>
                                            <li class="highlight menu-item animate-dropdown">
            ...
            <footer class="site-footer footer-v1">
                <div class="col-full">
                        ...
                        <div class="row">
                                    ...
                                    <div class="footer-contact-info">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <span class="call-us-text">(234) 81 3000 0000, (234) 81 3434 3333</span>
                                                <address class="footer-contact-address">Our comapany address here</address>
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="footer-payment-icons">
                                                    <ul class="list-payment-icons nav">
                                                        <li class="nav-item">
                                                            <img class="payment-icon-image" src="{{ asset('customer/images/credit-cards/mastercard.svg') }}" alt="mastercard" />
                                                        </li>
                                                        <li class="nav-item">
                                                            <img class="payment-icon-image" src="{{ asset('customer/images/credit-cards/visa.svg') }}" alt="visa" />
                                                        </li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="footer-secure-by-info">
                                                    ...
                                                    <ul class="footer-secured-by-icons">
                                                        <li class="nav-item">
                                                            <img class="secure-icons-image" src="{{ asset('customer/images/secured-by/norton.svg') }}" alt="norton" />
                                                        </li>
                                                        <li class="nav-item">
                                                            <img class="secure-icons-image" src="{{ asset('customer/images/secured-by/mcafee.svg') }}" alt="mcafee" />
                                                        </li>
                                                    </ul>
                                                </div>
                            ...
                            <div class="footer-widgets">
                                        ...
                                        <div class="body">
                                            ...
                                            <div class="menu-footer-menu-1-container">
                                                <ul id="menu-footer-menu-1" class="menu">
                                                    <li class="menu-item">
                                                        <a href="shop.html">Terms & Conditions</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="shop.html">Categories</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="shop.html">Supermarkets</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="shop.html">Delivery Terms</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="shop.html">Agents</a>
                                                    </li>
                                                    <li class="menu-item">
                                ...
                                <div class="columns">
                                    <aside class="widget clearfix">
                                        <div class="body">
                                            <h4 class="widget-title">Customer</h4>
                    ...
                    <div class="site-info">
                        <div class="col-full">
                            <div class="copyright">Copyright &copy; {{date('Y')}} <a href="javascript:void(0)">Skip Outlet</div>
                            <!-- .copyright -->
